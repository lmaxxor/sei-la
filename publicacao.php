...
try {
    $stmt = $pdo->prepare('SELECT p.*, u.nome_completo, u.avatar_url FROM comunidade_posts p JOIN utilizadores u ON p.id_utilizador = u.id_utilizador WHERE p.id_post = :id');
